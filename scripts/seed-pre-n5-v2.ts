...
const MODULES: ModuleSeed[] = [
  {
    ...
    objective: "Mengenali bunyi dan menulis 20 hiragana pertama dengan urutan serta arah goresan yang tepat, lalu mengingatnya melalui review tertunda.",
...
> = {
  ...
  F2: {
    ...
    description: "Konsolidasi 20 huruf sampai seluruh tulisan mandiri cocok dengan goresan logisnya.",
    configuration: {
      script: "hiragana",
      modes: ["guided", "ghost", "countdown"],
      ghostPreviewMs: 1000,
      countdownSeconds: 5,
      writingValidator: "logical-stroke-match",
    },
    passCriteria: { accuracyPercent: 100, practiceCharacterCount: 20 },
  },
  F3: {
    status: "ready",
