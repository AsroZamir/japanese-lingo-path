...
const MODULES: ModuleSeed[] = [
  {
    code: "PRE-N5.01",
    title: "Hiragana Path: 46 Huruf Dasar",
    description: "Menguasai 46 Hiragana secara bertahap dalam lima batch kecil, dengan tulisan aktif dan pengujian kumulatif.",
    objective: "Mengenali bunyi, menulis dengan urutan goresan yang tepat, dan mengingat seluruh 46 Hiragana tanpa bergantung pada romaji.",
    methodName: "Sound-Shape Anchor + Active Writing + Spaced Recall",
    moduleType: "SCR",
    orderIndex: 1,
    estimatedMinutesMin: 420,
    estimatedMinutesMax: 600,
    icon: "あ",
    status: "ready",
    bossTitle: "Hiragana Gate 46",
  },
  {
    code: "PRE-N5.02",
...
function hiraganaBatchConfiguration(
  batchStart: number,
  ...
  return {
    ...
    cumulativeCheckpointQuestions: Math.min(cumulativeCharacterCount, 20),
    writingValidator: {
      requireAllLogicalStrokes: true,
      requireCorrectOrder: true,
      requireCorrectDirection: true,
      requireUnaidedRecall: true,
    },
    hintLevels: ["stroke-count-and-motion-cue", "stroke-animation"],
  };
}
...
> = {
  F1: {
    status: "ready",
    title: "Batch 1: Vokal + K",
    mechanic: "+10 huruf baru - checkpoint kumulatif 10",
    description: "Pelajari a sampai ko dalam dua kelompok kecil. Fase berikutnya terbuka setelah tulisan mandiri dan soal campuran 10 huruf lulus.",
    configuration: hiraganaBatchConfiguration(0, 10, 10),
    passCriteria: {
      accuracyPercent: 80,
      requireAllUnits: true,
      requireUnaidedWriting: true,
    },
  },
  F2: {
    status: "ready",
    title: "Batch 2: S + T",
    mechanic: "+10 huruf baru - bank soal kumulatif 20",
    description: "Tambahkan sa sampai to. Checkpoint mencampur huruf baru dengan seluruh 10 huruf dari Fase 1.",
    configuration: hiraganaBatchConfiguration(10, 10, 20),
    passCriteria: { accuracyPercent: 80, requireAllUnits: true, requireUnaidedWriting: true },
  },
  F3: {
    status: "ready",
    title: "Batch 3: N + H",
    mechanic: "+10 huruf baru - bank soal kumulatif 30",
    description: "Tambahkan na sampai ho. Pengenalan, bunyi, recall, dan tulisan mengambil soal dari seluruh 30 huruf.",
    configuration: hiraganaBatchConfiguration(20, 10, 30),
    passCriteria: { accuracyPercent: 80, requireAllUnits: true, requireUnaidedWriting: true },
  },
  F4: {
    status: "ready",
    title: "Batch 4: M + Y + R Awal",
    mechanic: "+10 huruf baru - bank soal kumulatif 40",
    description: "Tambahkan ma sampai ri. Soal campuran memakai seluruh 40 huruf agar ingatan lama tetap aktif.",
    configuration: hiraganaBatchConfiguration(30, 10, 40),
    passCriteria: { accuracyPercent: 80, requireAllUnits: true, requireUnaidedWriting: true },
  },
  F5: {
    status: "ready",
    title: "Batch 5: Enam Huruf Terakhir",
    mechanic: "+6 huruf baru - bank soal kumulatif 46",
    description: "Tambahkan ru, re, ro, wa, wo, dan n. Review akhir mengambil soal dari semua 46 Hiragana.",
    configuration: {
      ...hiraganaBatchConfiguration(40, 6, 46, 3),
  ...
  BOSS: {
    status: "ready",
    title: "Hiragana Gate 46",
    mechanic: "Gate kumulatif: lihat, dengar, tulis",
    description: "Gerbang akhir mengambil soal dari seluruh 46 Hiragana tanpa petunjuk.",
    configuration: {
      script: "hiragana",
      batchStart: 0,
      newCharacterCount: 0,
      cumulativeCharacterCount: 46,
      questionCount: 46,
      timeLimitSeconds: 600,
      mix: { recognition: 16, audio: 15, writing: 15 },
      rewardBadge: "Hiragana 46 Pathfinder",
    },
